      ...
      >
        <div className="flex justify-center w-full md:w-auto">
          <Image
            ...
            className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 rounded-full object-cover border-4 border-slate-200 dark:border-slate-800 shadow-md mb-6 md:mb-0"
          />
        </div>
        <div className="w-full max-w-xl text-center md:text-left">
          <h2 className="text-2xl sm:text-3xl font-bold mb-2">Sobre mí</h2>
          <p className="text-slate-600 dark:text-slate-300 mb-4 text-base sm:text-lg">
          ...
          <ul className="list-disc list-inside text-slate-700 dark:text-slate-400 text-sm sm:text-base flex flex-col gap-1 sm:gap-2">
            <li>
